...
事实（chepin 截图实证，08-16）：付费包用量非零（输入 2,142,464+457,796、输出 3,889,422），**同时**按量计费也在烧（缓存命中输入 1,336,320+），余额 ¥106.61 来自 08-14 ¥50 + 08-16 ¥100 两笔微信充值；¥9.90/5000万 包已于 **08-16 13:14:33 到期**，新 ¥29.90/5000万 包有效期 08-14~09-13。
判读（假设待证）：①部分 API 密钥未绑资源包走按量；②到期/新包切换缝漏按量。烧速实测 ≈560k tok/h ≈ **13.4M/日** → 5000万 包纯包消耗仅够 ~3.7 天。
